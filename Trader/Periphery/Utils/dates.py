...
class Dates:
    ...
    def convert_delta(self, delta: dt.timedelta, unit_to_convert: str):

        total_seconds = delta.total_seconds()

        if unit_to_convert in self.minute_params:
            total = total_seconds / 60
            return total
        elif unit_to_convert in self.hour_params:
            total = total_seconds / 3600
            return total
        elif unit_to_convert in self.day_params:
            total = total_seconds / (24 * 3600)
            return total
        elif unit_to_convert in self.week_params:
            total = total_seconds / ((24 * 3600) * 7)
            return total
        elif unit_to_convert in self.month_params:
            total = total_seconds / (((24 * 3600) * 7) * 30)
            return total
